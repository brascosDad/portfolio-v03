...
function ArrowUpRight() {
  return (
    <svg
      ...
      className="inline-block ml-[5px] md:ml-[5px] w-[12px] h-[12px] md:w-[14px] md:h-[14px] lg:w-[16px] lg:h-[16px]"
    >
      <path
...
export function Nav() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-bg-primary/40 backdrop-blur-md border-b border-border/50">
      <div className="flex items-center justify-between px-10 md:px-30 lg:px-60 py-10 md:py-20 lg:py-20 max-w-[1440px] mx-auto">
