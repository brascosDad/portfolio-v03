...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    brief: "The Path to Pro Network was growing on the hiring side \u2014 but the candidates contractors were looking for weren\u2019t showing up in the numbers expected. The candidate experience hadn\u2019t been meaningfully tested since launch. I ran a design sprint to audit the current experience, study the competitive landscape, and identify where the greatest opportunities were before redesigning anything.",
    ...
    problemPoints: [
      "Candidate experience was inherited and untested",
      "No one knew what was working or where job seekers were dropping off",
    ],
    outcomePoints: [
    ...
    sections: [
      {
        ...
        subtitle: "What the market was already telling us.",
        body: "Before proposing anything, I needed to understand what the market looked like for skilled tradespeople. I mapped the competitive landscape \u2014 reviewing how other platforms handled navigation, mobile experience, profile building, search, and credentialing.",
        bodyExtra: "The audit surfaced two areas where no major competitor was investing: AI-assisted profile creation and job posting validation. Both were unaddressed across the market. That mattered \u2014 it meant we weren\u2019t just catching up, we had a chance to lead.",
        customComponent: "competitive-grid",
      },
      {
        heading: "Where the Work Was",
        subtitle: "Three areas. Each with real evidence behind it.",
        body: "The sprint brought together three input streams \u2014 a current-state audit, the competitive review, and previously collected but unanalyzed research. Each activity built on the one before it, narrowing from broad landscape observations to specific, evidence-backed opportunity areas.",
        customComponent: "sprint-structure",
        gateBlock: {
          heading: "Full findings available on request",
          body: "The three opportunity areas, prototype approaches, and usability findings are documented in a detailed walkthrough. This project is under active development \u2014 reach out and I\u2019ll share the full version.",
        },
      },
      {
        heading: "From Questions to Prototypes",
        subtitle: "Three areas, six prototypes, real tradespeople.",
        body: "Each opportunity area was explored through competing prototype approaches \u2014 two directions per area, six prototypes total. The prototypes weren\u2019t polished concepts; they were built to test specific assumptions about how tradespeople search for work and present themselves to employers.",
        bodyExtra: "We put all six in front of real tradespeople \u2014 electricians, HVAC technicians, general laborers \u2014 and watched how they responded. The sessions told us which approaches matched how these users actually think about finding work.",
